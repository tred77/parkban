...
--- park region --
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (1,{ts '2016-07-16'},{ts '2016-07-16'},5,12,126,'DAY')
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (2,{ts '2016-07-17'},{ts '2016-07-17'},5,13,626,'DAY')
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (3,{ts '2016-07-18'},{ts '2016-07-18'},5,14,526,'DAY')
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (4,{ts '2016-07-19'},{ts '2016-07-19'},5,15,426,'DAY')
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (5,{ts '2016-07-20'},{ts '2016-07-20'},5,16,326,'DAY')
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (6,{ts '2016-07-21'},{ts '2016-07-21'},5,17,226,'DAY')
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (6,{ts '2016-07-22'},{ts '2016-07-22'},5,17,226,'DAY')

insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (1,{ts '2016-07-16'},{ts '2016-07-22'},5,104,2550,'WEEK')
