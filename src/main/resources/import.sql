...
insert into TBL_DATE_DIMENSION (id,DATE_DIM_LEVEL,TITLE,START_DATE,END_DATE,START_DATE_FA,END_DATE_FA,YEAR,MONTH,WEEK) VALUES (47,'WEEK','هفته چهارم  تیر',{ts '2016-07-16'},{ts '2016-07-22'},13950426,13950501,1395,4,4);
