...
--- park region --
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (1,{ts '2016-07-30'},{ts '2016-07-30'},5,12,126,'DAY')
...
insert into TBL_REGION_PARK_INFO  (id,START_DATE,END_DATE,REGION_ID,TOTAL_PARK_DURATION,TOTAL_PARK_COST,DATE_DIM_LEVEL) values (1,{ts '2016-07-30'},{ts '2016-08-06'},5,104,2550,'WEEK')
