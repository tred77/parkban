...
insert into TBL_PARK_CHARGE(id, OWNER_ID, PLATE_NUMBER, CHARGE_TYPE, AMOUNT, LAST_CHARGE_DATE,LAST_CHARGE_AMOUNT) values(1,1,'222222222','Owner',12764,{ts '2016-07-16 08:50:52.69'}, 76542);
insert into TBL_PARK_CHARGE(id, OWNER_ID, PLATE_NUMBER, CHARGE_TYPE, AMOUNT, LAST_CHARGE_DATE,LAST_CHARGE_AMOUNT) values(2,1,'222222222','Owner',34563,{ts '2016-07-17 09:45:52.69'}, 53627);
insert into TBL_PARK_CHARGE(id, OWNER_ID, PLATE_NUMBER, CHARGE_TYPE, AMOUNT, LAST_CHARGE_DATE,LAST_CHARGE_AMOUNT) values(3,1,'222222222','Owner',56374,{ts '2016-07-18 10:42:52.69'}, 87123);
insert into TBL_PARK_CHARGE(id, OWNER_ID, PLATE_NUMBER, CHARGE_TYPE, AMOUNT, LAST_CHARGE_DATE,LAST_CHARGE_AMOUNT) values(4,1,'222222222','Owner',57840,{ts '2016-07-19 11:35:52.69'}, 65293);

insert into TBL_PARK_CHARGE(id, OWNER_ID, PLATE_NUMBER, CHARGE_TYPE, AMOUNT, LAST_CHARGE_DATE,LAST_CHARGE_AMOUNT) values(5,2,'444444444','Owner',12764,{ts '2016-07-26 03:50:52.69'}, 56042);
insert into TBL_PARK_CHARGE(id, OWNER_ID, PLATE_NUMBER, CHARGE_TYPE, AMOUNT, LAST_CHARGE_DATE,LAST_CHARGE_AMOUNT) values(6,2,'444444444','Owner',34563,{ts '2016-07-27 10:45:52.69'}, 63027);
insert into TBL_PARK_CHARGE(id, OWNER_ID, PLATE_NUMBER, CHARGE_TYPE, AMOUNT, LAST_CHARGE_DATE,LAST_CHARGE_AMOUNT) values(7,2,'444444444','Owner',56374,{ts '2016-07-28 06:42:52.69'}, 47023);
insert into TBL_PARK_CHARGE(id, OWNER_ID, PLATE_NUMBER, CHARGE_TYPE, AMOUNT, LAST_CHARGE_DATE,LAST_CHARGE_AMOUNT) values(8,2,'444444444','Owner',57840,{ts '2016-07-29 12:35:52.69'}, 95093);
