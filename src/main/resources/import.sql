...
-- parkbanTrack
insert into TBL_PARKBAN_TRACK(id, PARK_DATETIME, REGION_ID, PARKBAN_ID, LATITUDE, LONGITUDE) values(1, {ts '2016-07-16 08:30:52.69'}, null, 1,51.397179 , 35.739072);
insert into TBL_PARKBAN_TRACK(id, PARK_DATETIME, REGION_ID, PARKBAN_ID, LATITUDE, LONGITUDE) values(2, {ts '2016-07-16 08:35:52.69'}, null, 1,51.397608 , 35.739063);
insert into TBL_PARKBAN_TRACK(id, PARK_DATETIME, REGION_ID, PARKBAN_ID, LATITUDE, LONGITUDE) values(3, {ts '2016-07-16 08:40:52.69'}, null, 1, 51.398230 , 35.739072);
insert into TBL_PARKBAN_TRACK(id, PARK_DATETIME, REGION_ID, PARKBAN_ID, LATITUDE, LONGITUDE) values(4, {ts '2016-07-16 08:45:52.69'}, null, 1, 51.399179 , 35.739072);